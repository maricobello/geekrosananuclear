...
st.image("https://i.imgur.com/MMjJ81s.gif", use_column_width=True)
...
while True:
    ...
    if st.button("Enviar senha para o controle"):
        if senha_digitada == senha_correta:
            ...
            st.success("Adequando energia de fissão.......100%")
            time.sleep(2)
            st.success("Reestabelecendo sistema de resfriamento.......100%")
            time.sleep(2)
            st.success("Dispositivos de controle ONLINE.......100%")
            time.sleep(2)
            st.success("Reação de fissão controlada, temperatura normal reestabelecida!")
            time.sleep(2)
