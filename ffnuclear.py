...
with col3:
    st.write(' ')
st.markdown("<h1 style='text-align: center; color: red;'>TEMPO RESTANTE ATÉ EXPLOSÃO:</h1>", unsafe_allow_html=True)
...
while True:
    ...
    senha_digitada = st.text_input("<h2 style='text-align: center; color: white;'>DIGITE A SENHA DE ACESSO</h2>", key="senha")
